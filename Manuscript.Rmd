...
author: "jimi adams & Michał Bojanowski"
...
Figure 3. **Dynamic Visualization of Annual Trade Networks** Note: Intra-division trades are highlighted in red. Node color and position refers to division.
...
```{r mm-1976-2004}
mm_1976_2004 <- readRDS("mm_1976_2004.rds")
withr::with_options(
  list(knitr.kable.NA = ""),
  mm_1976_2004 %>%
...
```{r mm-2005-2019}
mm_2005_2019 <- readRDS("mm_2005_2019.rds")
withr::with_options(
  list(knitr.kable.NA = ""),
  mm_2005_2019 %>%
