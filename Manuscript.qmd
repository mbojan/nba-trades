...
```{r tbl-model1-table-short}
 withr::with_options(
   ...
   readRDS("model1-table-short.rds") |>
     knitr::kable(
       caption = "**Valued ERGM fitted to pooled seasonal data**. The table excludes seasonal constants, complete table is presented in Table [-@tbl-model1-table] the Appendix.",
